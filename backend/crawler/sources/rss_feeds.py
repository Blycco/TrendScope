...
KR_NEWS_FEEDS: list[FeedSource] = [
    ...
    {"url": "https://www.bloter.net/feed", "name": "블로터", "category": "tech", "locale": "ko"},
    {
    ...
    {"url": "https://platum.kr/feed", "name": "플래텀", "category": "tech", "locale": "ko"},
    {
...
GLOBAL_NEWS_FEEDS: list[FeedSource] = [
    ...
    {"url": "https://www.wired.com/feed/rss", "name": "Wired", "category": "tech", "locale": "en"},
    {
    ...
    {"url": "https://www.cnet.com/rss/news/", "name": "CNET", "category": "tech", "locale": "en"},
    {
    ...
    {"url": "https://9to5mac.com/feed/", "name": "9to5Mac", "category": "tech", "locale": "en"},
    {
    ...
    {"url": "https://phys.org/rss-feed/", "name": "Phys.org", "category": "tech", "locale": "en"},
    # --- Entertainment ---
    {
...
COMMUNITY_FEEDS: list[FeedSource] = [
    ...
    {
        "url": "https://rss.dcinside.com/?mi=ai",
        "name": "DC AI갤",
        "category": "tech",
        "locale": "ko",
    },
