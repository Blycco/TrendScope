				...
				<div class="flex h-16 items-center justify-between">
					<div class="flex items-center gap-8">
						...
						<div class="hidden sm:flex items-center gap-4" data-tour="nav-links">
							...
							<a href="/regional" class="text-sm text-gray-600 hover:text-gray-900">{$t('regional.title')}</a>
						</div>
					</div>
			...
			{#if mobileMenuOpen}
				<div class="sm:hidden border-t border-gray-200 bg-white">
					<div class="px-4 py-3 space-y-1">
						...
						<a href="/regional" class="block rounded-md px-3 py-2 text-sm text-gray-700 hover:bg-gray-100">{$t('regional.title')}</a>
