				...
				<div class="flex h-16 items-center justify-between">
					<div class="flex items-center gap-8">
						...
						<div class="hidden sm:flex items-center gap-4" data-tour="nav-links">
							...
							<a href="/brand" class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100" aria-current={$page.url.pathname.startsWith('/brand') ? 'page' : undefined}>{$t('nav.brand')}</a>
			...
			{#if mobileMenuOpen}
				<div class="sm:hidden border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900">
					<div class="px-4 py-3 space-y-1">
						...
						<a href="/brand" class="block rounded-md px-3 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800" aria-current={$page.url.pathname.startsWith('/brand') ? 'page' : undefined}>{$t('nav.brand')}</a>
